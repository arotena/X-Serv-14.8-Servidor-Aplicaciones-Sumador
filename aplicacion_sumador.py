...
class webApp:
    ...
    def parse(self, request):
        ...
        return "Introducir numero esperando..."

    def process(self, parsedRequest):
        """Process the relevant elements of the request.
        Returns the HTTP code for the reply, and an HTML page.
        """
        return ("200 OK", "<html><body><h1>"+ str(parsedRequest) +"</h1></body></html>")

    def suma(self, elemento1, elemento2):
    ...
    def __init__(self, hostname, port):
        ...
        try:
            ...
            while True:
                ...
                if(numero != ""):
                    if primero != None:
                        resultado = self.suma(primero,numero)
                        parsedRequest = "El resultado es: " + str(primero) + " + "
                        parsedRequest += str(numero) + " = " + str(resultado)
                        primero = None
                    else:
            			primero = numero
            			parsedRequest = "Dame otro numero"
